...
> source ~/.bash_profile
> ```
3.9 is used here as an example, change it to where python lives on your system.
...
> }
> ```
> If it says `dir('project-tools/jenkins-examples/Example_3')`, update it to `dir('Example_3')` or the directory to where Example_3 exists on your local before pushing. This is the most common mistake and will cause the pipeline to fail with `No POM in this directory`.
