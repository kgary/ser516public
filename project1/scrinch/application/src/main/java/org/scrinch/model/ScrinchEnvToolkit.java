...
public class ScrinchEnvToolkit {
    ...
    public Calendar getPreparedCalendarInstance() {
        ...
        if (preparedCalendar != null) {
            // preparedCalendar instance is not null for tests only
            ...
            try {
                ...
                Formatter formatter = new java.util.logging.Formatter() {
                    ...
                    public synchronized String format(LogRecord record) {
                        ...
                        //log.append(" - [Thread #").append(record.getThreadID()).append("]");
                        //log.append(" : ").append(record.getSourceClassName()).append(".").append(record.getSourceMethodName()).append("()");
    ...
    public boolean isSomethingToSave() {
        return !memberFactory.getMemberList().isEmpty()
                || !itemFactory.getItemList().isEmpty()
                || !projectFactory.getList().isEmpty()
                || !sprintFactory.getSprintList().isEmpty();
    }
    ...
    private void buildModel(ScrinchEnv data) throws ScrinchException, ScrinchException, UnsupportedEncodingException {
        ...
        if (data.getPeople() != null) {
            // people struct is deprecated (replaced by members), 
                ...
                if (file.exists()) {
                    ...
                    if (canRename) {
                        ...
                        logger.log(Level.WARNING,
                                "Could not rename file to old file : "
                                + "current old file could not be deleted. "
                                + "Operation skipped");
                    }
                }
    ...
    public void open(File file) throws IOException, MarshalException,
            ValidationException, ScrinchException, ScrinchException {
    ...
    public void open(byte[] data) throws IOException, MarshalException,
            ValidationException, ScrinchException, ScrinchException {
