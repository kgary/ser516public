...
public class MembersComboBoxModel implements ComboBoxModel {

    private List<Member> memberList;
    private Member selectedItem;
    private List<ListDataListener> listDataListenerList = new Vector();

    public MembersComboBoxModel(ScrinchEnvToolkit toolkit) {
        memberList = toolkit.getMemberFactory().getActiveMemberList();
    }

    public void setSelectedItem(Object object) {
        try {
            this.selectedItem = (Member) object;
        } catch (Exception e) {
