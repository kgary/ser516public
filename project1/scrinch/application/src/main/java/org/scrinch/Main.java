            ...
            if (args.length > 1) {
                ...
                if (fileName != null && new File(fileName).exists()) {
                    int result = JOptionPane.showConfirmDialog(mainFrame,
                            ...
                            "Scrinch : open last file?", JOptionPane.YES_NO_OPTION);
...
//            } catch (Exception e) {}
            ...
            if (maxMem < 110000) {
                JOptionPane.showMessageDialog(null, "Insufficient memory allocated, use parameter -Xmx128m to set at least 128 Mb max memory to run the Scrinch application.",
